...
cd $EXP_ROOT
readonly CAMPAIGN_ROOT_DIR="kitten/gcc/fuzz4all-seeds"
...
java -Xmx210G -Xms30G -jar $EXP_ROOT/kitten_deploy.jar \
  --testing-config "$EXP_ROOT/kitten/gcc/fuzz4all-seeds-config.yaml" \
  --random-seed 0 \
